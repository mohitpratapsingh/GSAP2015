...
public class ProductDaoImpl implements ProductDao {
	...
	public int saveProduct(Products product) throws Exception {
		try{
    		...
    		int count=jdbcTemplate.update(sql1,product.getProdId(),product.getProdName(),product.getPrice(),product.getQuantity());
	...
	public int updateProduct(Products product,long productId) throws Exception {
		try {
			...
			int count=jdbcTemplate.update(sql2,product.getProdName(),product.getPrice(),product.getQuantity(),productId);
