...
<body>
<p>Hello admin! <%= session.getAttribute( "emailId" ) %></p>

<h4>${error}</h4>
 
<div style="position: absolute; top: 0; right: 0; width: 100px; text-align:right;"><p><b>Welcome ${Name}</b></p></div>
...
<form:form action="productDeleteSubmit" method="post" commandName="productDeleteForm">
<table border="3">
<thead>
<tr>Product List</tr>
<tr>
...
<tbody> 
 <c:forEach items="${Productlist}" var="users">
    <tr>
    <td><input type="checkbox" name="prodList" value="${users.prodId}">
      <td>${users.prodId}</td>
